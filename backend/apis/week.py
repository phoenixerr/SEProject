...
api = Namespace('Weeks', description='Collection of week endpoints')
...
class CourseWeekAPI(Resource):
    @jwt_required()
    @api.doc(description = "Returns the summary of all the weeks of the course with specified course ID.")
    ...
    @api.doc(description = "Add summary of new week to the course with specified course ID.")
...
class WeekAPI(Resource):
    @jwt_required()
    @api.doc(description = "Returns the details of the week with specified week ID.")
    ...
    @jwt_required()
    @api.expect(week_parser)
    @api.doc(description = "Modify the details of the week with specified week ID.")
    ...
    @jwt_required()
    @api.doc(description = "Delete the details of the week with specified week ID.")
...
class WeekSummaryAPI(Resource):
    @jwt_required()
    @api.doc(description = "Modify the summary of the week with specified week ID.\nGenerated by Gemini LLM")
    def put(self, week_id):
        user_id = get_jwt_identity()
        user = User.query.get(user_id)
        if not user:
